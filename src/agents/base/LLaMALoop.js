...
exports.runLLaMALoop = void 0;
const GroqClient_1 = require("./GroqClient");
const ToolRegistry_1 = require("./ToolRegistry");
const pino_1 = __importDefault(require("pino"));
const logger = (0, pino_1.default)();
const maxIterations = 5;
const runLLaMALoop = async (initialMessages, toolsAllowed = [], context, taskType = 'default') => {
    ...
    const allTools = (0, ToolRegistry_1.getGroqTools)();
    ...
    for (let i = 0; i < maxIterations; i++) {
        ...
        const message = await (0, GroqClient_1.executeGroqWithRetry)(effectiveMessages, hasTools ? currentAllowedTools : [], taskType);
        ...
        if (message.tool_calls && message.tool_calls.length > 0) {
            ...
            for (const toolCall of message.tool_calls) {
                try {
                    const result = await (0, ToolRegistry_1.executeTool)(toolCall.function.name, toolCall.function.arguments, context);
...
exports.runLLaMALoop = runLLaMALoop;
